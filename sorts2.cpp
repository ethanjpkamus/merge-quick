...
void test_sort_from_file(const std::string& msg, const std::string& filename,
  ...
  ifs.close();
  test_sort("\n\nAfter " + msg + " sorting, "+filename+" is now: \n\n", words, n, comp, sort); //+filename+ used to be "words"
...
int main(int argc, const char * argv[]) {
    ...
    test_sort_from_file<std::string>("quick_sort", "words3.txt", quick_sort2<std::string>());
    test_sort_from_file<std::string>("quick_sort", "dutch.txt", quick_sort2<std::string>());
    test_sort_from_file<std::string>("quick_sort2_3way", "words3.txt", quick_sort2_3way<std::string>());
    test_sort_from_file<std::string>("quick_sort2_3way", "dutch.txt", quick_sort2_3way<std::string>());
    ...
    /*
    std::function<bool(const student_ex& a, const student_ex& b)> gpa_then_age = [](const student_ex& a,const student_ex& b) {
